    ...
    <>
      ...
      <main className="flex-1 px-4 py-12 sm:py-16">
        <div className="mx-auto max-w-sm">
          ...
          <button className="mt-6 w-full inline-flex items-center justify-center gap-2 rounded-xl border border-espresso/15 bg-white px-4 py-3 text-sm font-medium text-espresso hover:bg-espresso/5 transition-colors">
